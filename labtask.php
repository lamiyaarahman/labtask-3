			...
			if ($_SERVER["REQUEST_METHOD"] == "POST")
   {
  	 ...
  	 else
     {
	  ...
	  if (empty($_POST["Username"]))
      {
  	 ...
  	 {
  	  $err_Username="Username must contain at least 6 characters and space is not allowed.";
	  $hasError=true;
  	 ...
  	 else
     {
  	     ...
  	     if (empty($_POST["Password"]))
      {
  	 ...
  	 {
  	  $err_Password="Password must contain at least 8 character, 1 special character(only check # or ?),1 number and combination of uppercase and lowercase alphabet.";
	  $hasError=true;
  	 }
  	 else
     {
	  ...
	  if (empty($_POST["Confirm Password"]))
      {
  	 ...
  	 {
  	  $err_ConfirmPassword="Confirm Password must be Atleast 8 charecter";
	  $hasError=true;
  	 }
  	 else
     {
     ...
     else if(strlen($_POST["Enter Your Email Address"]))
  	 {
  	 ...
  	 else
     {
  	...
  	/* if (empty($_POST["Where did you hear aboutus?"]))
       {
      $err_Wheredidyouhearaboutus? = "select Where did you hear about us?";
	  $hasError=true;
      } else
       {
       $Wheredidyouhearaboutus? =$_POST["Where did you hear about us?"];
     }*/
		 ...
		 <form action="" method="post">
			<table>
				...
				<td><span>Confirm Password</span></td>
					<td>:<input type="Password" name="Confirm Password"value="<?php echo $ConfirmPassword?>" <span><?php echo $err_ConfirmPassword?>
					</span></td>
				</tr>
				<tr>
				...
				<td><span>Address</span></td>
					...
					:<input type placeholder="Pastal/Zip Code"="Address" name="Address" <span>
					</span></td>
				</tr>
				...
				<tr>
					...
					<td>:<input type="checkbox" value="Google" name="Hobbies[]">Google<br>
